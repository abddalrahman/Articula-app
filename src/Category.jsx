...
const Category = () => {
	...
	useEffect(()=>{
		...
		if(idIs && !isNaN(Number(idIs)) && idIs.trim() != ''){
			...
			fetch(`https://tamkeen-dev.com/api/blogs-api?items_per_page=${ipp}&page=${cp}&category=${idIs}&sort_by=created_date&sort_order=DESC`, {
				method: 'GET',
				headers: {
					'Content-Type': 'application/json',
	...
	return (
		<div className='articles-by-category py-5'>
			<div className='nav-container'>
				{
					...
					?
						...
						?
							...
							?
								<>
									{catName.error == ''? <h1 className='mb-5 mt-3 text-center'>Category: {catName.name}</h1> : '' } 
									{
